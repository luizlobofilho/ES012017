...
<header>
    <img src="<?php echo base_url('assets/images/logos/logoUnBook3.png') ;?>">
</header>

<link rel="icon" href="<?php echo base_url('assets/images/logos/favicon.png'); ?>" type="image/gif">
...
<body background="<?php echo base_url('assets/css/images/microchip.png') ;?>">
